...
function dataHandling2(arrInput) {
    arrInput.splice(1,1, 'Roman Alamsyah Elsharawy'); // Splice adalah fungsi array yang menghapus dan/atau menambah nilai ke dalam array. Fungsi splice menerima satu, dua, atau lebih parameter.//
